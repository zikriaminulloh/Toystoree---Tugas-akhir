...
<html lang="en">
  <head>
    ...
    <title>Home User-TOYSTOREE</title>
  </head>
  <body>
    <!-- header  -->
    <div class="header">
            ...
            <div class="row mx-0 mt-2" style="height: 200px">
              <div class=" col-2 pl-0">
                ...
                >
                  ...
                  <div class="w-100 d-flex flex-column px-2">
                    <span><a href="detail1user.php" style="color: #000;  text-decoration: none;">Batman head lego</a></span>
                    <div
                      class="
                        w-100
                        pb-2
              ...
              <div class="col-2 pl-0">
                ...
                >
                  ...
                  <div class="w-100 d-flex flex-column px-2">
                    <span><a href="detail2user.php" style="color: #000;  text-decoration: none;">Squirrel Doll</a></span>
                    <div
                      class="
                        w-100
                        pb-2
      ...
      <div class="d-flex justify-content-between">
        ...
        <div class="d-flex flex-column ml-5">
          ...
          <div class="d-flex flex-column">
            <div class="d-flex align-items-center">
              <a href="https://web.facebook.com/zikri.gemers.1/" style="text-decoration:none;  color:#888;">
              <i class="fa-brands fa-facebook"></i>
              <span class="desc ml-3">Facebook</span>
            </a>
            </div>
            <div class="d-flex align-items-center">
              <a href="https://instagram.com/zikri_amnllh?igshid=YmMyMTA2M2Y=" style="text-decoration:none; color:#888;">
        ...
        <div class="d-flex flex-column ml-5">
          ...
          <a href="https://smkn4malang.sch.id/" style="text-decoration: none; color:#888;">
          <div>
