...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css\guest\detail1guest.css"/>
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline mt-auto" href="detail2guest.php">View options</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
