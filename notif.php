        ...
        <div class="contener">
          ...
          <div class="navbar">
              <div class="d-flex align-items-center">
                ...
                <a href="/notif" style="color: white; margin-left: 15px; text-decoration:none;">
                  <i class="fa-regular fa-bell "></i>
                  <span class="text-notif">Notifikasi</span>
                </a>
              </div>
              <div class="d-flex align-items-center">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item-satu" href="#">My Account</a></li>
                        <li><a class="dropdown-item-dua" href="#">My Purchase</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item-tiga" href="login.php">Logout</a></li>
                    </ul>
                </div>
              </div>
              <!-- input search brand -->
