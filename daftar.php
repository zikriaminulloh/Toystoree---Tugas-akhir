  ...
  <div class="header">
    ...
    <form action="pdaftar.php" method="POST">
        <div class="container-daftar">
            ...
            <div class="tombol">
                <a href="login.php"><button class="daftar" type="submit">Next</button></a>
            </div>
            <p class="text">Sudah punya akun? <a href="login.php" class="text-register">Log-in</a></p>
          </div>
        </div>
      </form>
